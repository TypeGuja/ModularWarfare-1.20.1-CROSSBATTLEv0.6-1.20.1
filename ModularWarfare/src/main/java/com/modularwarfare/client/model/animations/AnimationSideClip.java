...
public class AnimationSideClip extends WeaponAnimation {
    ...
    public void onAmmoAnimation(ModelGun gunModel, float ammoProgress, int reloadAmmoCount, AnimStateMachine animation,
        ...
        poseStack.mulPose(com.mojang.math.Axis.YP.rotationDegrees(180.0f * bulletProgress));
        poseStack.mulPose(com.mojang.math.Axis.YP.rotationDegrees(60.0f * bulletProgress));
        poseStack.translate(0.5f * bulletProgress * 1.0f / gunModel.config.extra.modelScale, 0, 0);
    }
