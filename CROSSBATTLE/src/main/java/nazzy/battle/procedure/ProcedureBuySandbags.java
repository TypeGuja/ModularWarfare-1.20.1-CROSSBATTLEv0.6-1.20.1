...
public class ProcedureBuySandbags {
    ...
    public static void executeProcedure(HashMap<String, Object> dependencies) {
        if (dependencies.get("entity") == null || dependencies.get("x") == null ||
            ...
            System.err.println("Failed to load dependencies for procedure BuySandbags!");
            return;
        }
        ...
        if (currentMoney >= price) {
            ...
            if (entity instanceof Player player) {
                ItemStack stack = new ItemStack(InitBlocks.SANDBAG.get().asItem(), 1);
