...
public class ProcedureDestroyedDiamondTick {

    public static void executeProcedure(HashMap<String, Object> dependencies) {
        if (dependencies.get("x") == null || dependencies.get("y") == null ||
                dependencies.get("z") == null || dependencies.get("world") == null) {
            System.err.println("Failed to load dependencies for procedure DestroyedDiamondTick!");
            return;
        }
        ...
        if (blockEntity instanceof DestroyedOreBlockEntity destroyed) {
            ...
            if (time <= 1) {
                world.setBlock(pos, InitBlocks.ORE_DIAMOND.get().defaultBlockState(), 3);
