...
public class ProcedureBuyMedkit {
    ...
    public static void executeProcedure(HashMap<String, Object> dependencies) {
        if (dependencies.get("entity") == null || dependencies.get("x") == null ||
            ...
            System.err.println("Failed to load dependencies for procedure BuyMedkit!");
            return;
        }
        ...
        if (currentMoney >= price) {
            ...
            if (entity instanceof Player player) {
                ItemStack stack = new ItemStack(InitItems.MEDKIT.get(), 1);
