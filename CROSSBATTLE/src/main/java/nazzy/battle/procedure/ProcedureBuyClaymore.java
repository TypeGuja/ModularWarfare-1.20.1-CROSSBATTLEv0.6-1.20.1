...
public class ProcedureBuyClaymore {
    ...
    public static void executeProcedure(HashMap<String, Object> dependencies) {
        if (dependencies.get("entity") == null || dependencies.get("x") == null ||
            ...
            System.err.println("Failed to load dependencies for procedure BuyClaymore!");
            return;
        }
        ...
        if (currentMoney >= price) {
            ...
            if (entity instanceof Player player) {
                ItemStack stack = new ItemStack(InitBlocks.CLAYMORE.get().asItem(), 1);
